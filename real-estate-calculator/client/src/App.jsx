...
import DistressedFinder from './pages/DistressedFinder';
import FOIAManager from './pages/FOIAManager';
import ZoningIntel from './pages/ZoningIntel';

const navItems = [
  { path: '/', label: 'New Deal', icon: '+' },
  { path: '/deals', label: 'My Deals', icon: '#' },
  { path: '/leads', label: 'Leads', icon: '@' },
  { path: '/distressed', label: 'Distressed', icon: '!' },
  { path: '/foia', label: 'FOIA', icon: 'F' },
  { path: '/zoning', label: 'Zoning', icon: 'Z' },
    ...
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        <Routes>
          ...
          <Route path="/distressed" element={<DistressedFinder />} />
          <Route path="/foia" element={<FOIAManager />} />
          <Route path="/zoning" element={<ZoningIntel />} />
